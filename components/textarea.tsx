    ...
    <div className="relative w-full pt-4">
      ...
      {status === "streaming" || status === "submitted" ? (
        ...
        <button
          ...
          className="absolute right-2 bottom-2 rounded-full p-2 bg-black hover:bg-zinc-800 disabled:bg-zinc-300 dark:disabled:bg-zinc-900 disabled:cursor-not-allowed transition-colors"
        >
